...
/*
    switch(_songDataColumn) {
        case 0:
            return SETHI(song[_songRow].track[_channelNum], 0);
        case 1:
            return SETLO(song[_songRow].track[_channelNum], 0);
        case 3:
            return SETHI(song[_songRow].transp[_channelNum], 0);
        case 4:
            return SETLO(song[_songRow].transp[_channelNum], 0);
    }
*/
    return 0;
}
...
/*
    switch(_songDataColumn) {
        case 0:
            return SETHI(song[_songRow].track[_channelNum], _data);
        case 1:
            return SETLO(song[_songRow].track[_channelNum], _data);
        case 3:
            return SETHI(song[_songRow].transp[_channelNum], _data);
        case 4:
            return SETLO(song[_songRow].transp[_channelNum], _data);
    }
*/
    return _data;
}
                                        ...
                                        case Cmd1Bit_ExternalVoiceFlag:
                                            return _instrumentColumn < 5
                                                   ...
                                                   : labelString(
                                                            ...
                                                            _instrumentColumn - 5);
                                        case Cmd1Bit_NoteOffJmpPosition:
                                            return labelString("NoteOff", _instrumentColumn);
                                        default: return ' ';
                                    }
                                }
                            }

...
static inline void _m6581_set_ctrl(m6581_voice_t *v, uint8_t data) {
  ...
  if ((data & 0xF0) > 0x80) {
    v->noise_shift &=
        0x007FFFFF ^ (1 << 22) ^ (1 << 20) ^ (1 << 16) ^ (1 << 13) ^ (1 << 11) ^ (1 << 7) ^ (1 << 4) ^ (1 << 2);
  }
...
static inline void _m6581_voice_tick(m6581_t *sid, int voice_index) {
  ...
  switch ((v->ctrl >> 4) & 0x0F) {
    case 0: sm = _m6581_wavnone(v);
      break;
    case 1: sm = _m6581_triangle(v, v_sync);
      break;
    case 2: sm = _m6581_sawtooth(v);
      break;
    case 3: sm = _m6581_trisaw(v, v_sync);
      break;
    case 4: sm = _m6581_pulse(v);
      break;
    case 5: sm = _m6581_tripulse(v, v_sync);
      break;
    case 6: sm = _m6581_sawpulse(v);
      break;
    case 7: sm = _m6581_trisawpulse(v, v_sync);
      break;
    case 8: sm = _m6581_noise(v);
      break;
    default: sm = 0;
      break;
  }
    ...
    if ((v->env_state == M6581_ENV_ATTACK) ||
      ...
      switch (v->env_state) {
        ...
        case M6581_ENV_DECAY:
          ...
          break;
        case M6581_ENV_RELEASE:v->env_cur_level = (v->env_cur_level - 1) & 0xFF;
          if (0 == v->env_cur_level) {
            v->env_state = M6581_ENV_FROZEN;
          }
          break;
        case M6581_ENV_FROZEN:v->env_cur_level = 0;
          break;
      }
    }
  }
...
static uint64_t _m6581_read(m6581_t *sid, uint64_t pins) {
  ...
  switch (reg) {
    ...
    case M6581_OSC3RAND:
      ...
      break;
    case M6581_ENV3:sid->bus_value = 0;
      data = sid->voice[2].env_cur_level;
      break;
    default:data = sid->bus_value;
      break;
  }
...
static void _m6581_write(m6581_t *sid, uint64_t pins) {
  ...
  sid->bus_decay = 0x2000;
  switch (reg) {
    case M6581_V1_FREQ_LO:_m6581_set_freq_lo(&sid->voice[0], data);
      break;
    case M6581_V1_FREQ_HI:_m6581_set_freq_hi(&sid->voice[0], data);
      break;
    case M6581_V1_PW_LO:_m6581_set_pw_lo(&sid->voice[0], data);
      break;
    case M6581_V1_PW_HI:_m6581_set_pw_hi(&sid->voice[0], data);
      break;
    case M6581_V1_CTRL:_m6581_set_ctrl(&sid->voice[0], data);
      break;
    case M6581_V1_ATKDEC:_m6581_set_atkdec(&sid->voice[0], data);
      break;
    case M6581_V1_SUSREL:_m6581_set_susrel(&sid->voice[0], data);
      break;
    case M6581_V2_FREQ_LO:_m6581_set_freq_lo(&sid->voice[1], data);
      break;
    case M6581_V2_FREQ_HI:_m6581_set_freq_hi(&sid->voice[1], data);
      break;
    case M6581_V2_PW_LO:_m6581_set_pw_lo(&sid->voice[1], data);
      break;
    case M6581_V2_PW_HI:_m6581_set_pw_hi(&sid->voice[1], data);
      break;
    case M6581_V2_CTRL:_m6581_set_ctrl(&sid->voice[1], data);
      break;
    case M6581_V2_ATKDEC:_m6581_set_atkdec(&sid->voice[1], data);
      break;
    case M6581_V2_SUSREL:_m6581_set_susrel(&sid->voice[1], data);
      break;
    case M6581_V3_FREQ_LO:_m6581_set_freq_lo(&sid->voice[2], data);
      break;
    case M6581_V3_FREQ_HI:_m6581_set_freq_hi(&sid->voice[2], data);
      break;
    case M6581_V3_PW_LO:_m6581_set_pw_lo(&sid->voice[2], data);
      break;
    case M6581_V3_PW_HI:_m6581_set_pw_hi(&sid->voice[2], data);
      break;
    case M6581_V3_CTRL:_m6581_set_ctrl(&sid->voice[2], data);
      break;
    case M6581_V3_ATKDEC:_m6581_set_atkdec(&sid->voice[2], data);
      break;
    case M6581_V3_SUSREL:_m6581_set_susrel(&sid->voice[2], data);
      break;
    case M6581_FC_LO:_m6581_set_cutoff_lo(&sid->filter, data);
      break;
    case M6581_FC_HI:_m6581_set_cutoff_hi(&sid->filter, data);
      break;
    case M6581_RES_FILT:_m6581_set_resfilt(&sid->filter, data);
      break;
    case M6581_MODE_VOL:_m6581_set_modevol(sid, data);
      break;
  }
}
